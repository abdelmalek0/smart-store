...
import 'package:smart_store_linux/features/events/base/event_severity.dart';
...
class KitchenSupervisionPlugin extends SmartStorePlugin {
  ...
  String _violationLabel = 'No Gloves'; // Default label
  ...
  Future<void> onInit(Map<String, dynamic> config) async {
    ...
    if (config.containsKey('violationLabel')) {
      _violationLabel = config['violationLabel'];
    }
