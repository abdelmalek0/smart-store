...
import 'package:smart_store_linux/features/rendering/display_queue.dart';
import 'package:smart_store_linux/features/streaming/bridge/video_bridge.dart';
...
class RenderingOrchestrator {
  static final RenderingOrchestrator _instance = RenderingOrchestrator._internal();
  factory RenderingOrchestrator() => _instance;
  static RenderingOrchestrator get instance => _instance;

  // Platform-specific video bridge (created once via factory)
  final VideoBridge _bridge = VideoBridge();

  RenderingOrchestrator._internal();
